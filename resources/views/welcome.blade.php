...
<body>
    <div class="desk-shell">
                <aside class="desk-rail">
                    ...
                    <div class="rail-note"><i data-lucide="quote" aria-hidden="true"></i><p>Small steps, consistently taken, make substantial work.</p><span>James Clear</span></div>
                ...
                <main class="desk-main">
                    ...
                    <section class="desk-intro"><div><p class="desk-overline">One clear direction</p><h1>Clear the<br><em>runway.</em></h1></div><p class="desk-intro-copy">Keep the important things visible. Move through them one considered step at a time.</p></section>
                    ...
                    <footer class="desk-footer"><span>focus desk</span><span>Designed for deliberate progress</span></footer>
                </main>
    </div>
